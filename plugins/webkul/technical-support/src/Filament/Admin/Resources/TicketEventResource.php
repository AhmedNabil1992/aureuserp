...
use Webkul\TechnicalSupport\Filament\Admin\Resources\TicketEventResource\Pages\ManageTicketEvents;
...
class TicketEventResource extends Resource
{
    ...
    protected static ?string $slug = 'support-ticket-events';
    ...
    {
        return __('technical-support::filament/admin/resources/ticket-event.navigation.title');
    }
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            TextColumn::make('ticket.ticket_number')->label(__('technical-support::filament/admin/resources/ticket-event.table.columns.ticket'))->searchable(),
            TextColumn::make('type')->searchable(),
            TextColumn::make('user.name')->label(__('technical-support::filament/admin/resources/ticket-event.table.columns.user'))->searchable(),
            TextColumn::make('partner.name')->label(__('technical-support::filament/admin/resources/ticket-event.table.columns.partner'))->searchable(),
