        ...
        'sections' => [
            'general' => [
                ...
                'fields' => [
                    ...
                    'code-hint-tooltip' => 'الاسم المختصر يُستخدم كمُعرف للمستودع.',
                    'company' => 'الشركة',
                    'address' => 'العنوان',
                ],
            ],
            ...
            'settings' => [
                ...
                'fields' => [
                    ...
                    'incoming-shipments-hint-tooltip' => 'المسار الافتراضي للشحنات الواردة',
                    'outgoing-shipments' => 'الشحنات الصادرة',
                    'outgoing-shipments-hint-tooltip' => 'المسار الافتراضي للشحنات الصادرة',
                    'resupply-management' => 'إدارة إعادة التوريد',
                    'resupply-management-hint-tooltip' => 'سيتم إنشاء المسارات تلقائياً لإعادة تزويد هذا المستودع من المستودعات المحددة.',
